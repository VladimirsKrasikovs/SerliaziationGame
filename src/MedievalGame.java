...
public class MedievalGame {
    ...
    private void save() {
        ...
        try{
            FileOutputStream userSaveFile = new FileOutputStream ("Player.txt");
    ...
    private Player load(String playerName, Scanner console) {
        ...
        try{
            ...
            addDelay(1500);
            System.out.println("\n There was a problem loading character");
            System.out.println("If you're sure the spelling is correct, your character file may no longer exist");
